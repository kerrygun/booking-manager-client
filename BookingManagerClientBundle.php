...
use OpenAPI\Server\DependencyInjection\Compiler\BookingManagerClientApiPass;

/**
 * BookingManagerClientBundle Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server
 * @author   OpenAPI Generator team
 * @link     https://github.com/openapitools/openapi-generator
 */
class BookingManagerClientBundle extends Bundle
{
    public function build(ContainerBuilder $container)
    {
        $container->addCompilerPass(new BookingManagerClientApiPass());
    }
}
