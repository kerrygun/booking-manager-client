 ...
 *
 * Describes a single country in Booking Manager. It is a standard country entry with standard ISO elements for *name*, *shortCode*, *longCode* and numerical country *id*. *worldRegion* field links to an MMK defined world region available via *_/worldRegions* call
 *
 * @package OpenAPI\Server\Model
 * @author  OpenAPI Generator team
 */
class Country 
{
     ...
     * @Type("int")
     */
    protected ?int $worldRegion = null;
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->worldRegion = $data['worldRegion'] ?? null;
    }
     ...
     * Sets worldRegion.
     *
     * @param int|null $worldRegion
     *
     * @return $this
     */
    public function setWorldRegion(?int $worldRegion): self
    {
