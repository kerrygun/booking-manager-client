 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\AvailabilityResponse
 */
class AvailabilityResponseTest extends TestCase
{
    protected AvailabilityResponse|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(AvailabilityResponse::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(AvailabilityResponse::class));
        $this->assertInstanceOf(AvailabilityResponse::class, $this->object);
    }
    ...
    /**
     * Test attribute "optionExpirationDate"
     *
     * @group unit
     * @small
     */
    public function testPropertyOptionExpirationDate(): void
    {
        $this->markTestSkipped('Test for property optionExpirationDate not implemented');
    }
}
