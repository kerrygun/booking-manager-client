 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Base
 */
class BaseTest extends TestCase
{
    protected Base|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Base::class)->getMockForAbstractClass();
    }
    ...
    public function testTestClassExists(): void
    {
        ...
        $this->assertInstanceOf(Base::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyCountryId(): void
    {
        $this->markTestSkipped('Test for property countryId not implemented');
    }

    /**
     * Test attribute "sailingAreas"
     *
     * @group unit
     * @small
     */
    public function testPropertySailingAreas(): void
    {
        $this->markTestSkipped('Test for property sailingAreas not implemented');
    }
}
