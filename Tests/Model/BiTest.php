 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Bi
 */
class BiTest extends TestCase
{
    protected Bi|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Bi::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Bi::class));
        $this->assertInstanceOf(Bi::class, $this->object);
    }
