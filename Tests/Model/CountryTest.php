 ...
 *
 * @category    Class
 * @description Describes a single country in Booking Manager. It is a standard country entry with standard ISO elements for *name*, *shortCode*, *longCode* and numerical country *id*. *worldRegion* field links to an MMK defined world region available via *_/worldRegions* call
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Country
 */
class CountryTest extends TestCase
{
    protected Country|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Country::class)->getMockForAbstractClass();
    }
    ...
    public function testTestClassExists(): void
    {
        ...
        $this->assertInstanceOf(Country::class, $this->object);
    }
    ...
    {
        $this->markTestSkipped('Test for property short not implemented');
    }
    ...
    {
        $this->markTestSkipped('Test for property long not implemented');
    }

    /**
     * Test attribute "worldRegion"
     *
     * @group unit
     * @small
     */
    public function testPropertyWorldRegion(): void
    {
        $this->markTestSkipped('Test for property worldRegion not implemented');
    }
}
