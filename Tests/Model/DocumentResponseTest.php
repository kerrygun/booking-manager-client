 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\DocumentResponse
 */
class DocumentResponseTest extends TestCase
{
    protected DocumentResponse|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(DocumentResponse::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(DocumentResponse::class));
        $this->assertInstanceOf(DocumentResponse::class, $this->object);
    }
