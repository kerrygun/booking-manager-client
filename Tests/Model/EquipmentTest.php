 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Equipment
 */
class EquipmentTest extends TestCase
{
    protected Equipment|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Equipment::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Equipment::class));
        $this->assertInstanceOf(Equipment::class, $this->object);
    }
