...
/**
 * FlexibilityTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Flexibility
 */
class FlexibilityTest extends TestCase
{
    protected Flexibility|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Flexibility::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Flexibility::class));
        $this->assertInstanceOf(Flexibility::class, $this->object);
    }
}
