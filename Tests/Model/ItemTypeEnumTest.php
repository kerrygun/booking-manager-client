...
/**
 * ItemTypeEnumTest Class Doc Comment
 *
 * @category    Class
 * @description ItemTypeEnum
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ItemTypeEnum
 */
class ItemTypeEnumTest extends TestCase
{
    protected ItemTypeEnum|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(ItemTypeEnum::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ItemTypeEnum::class));
        $this->assertInstanceOf(ItemTypeEnum::class, $this->object);
    }
}
