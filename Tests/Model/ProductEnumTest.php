...
/**
 * ProductEnumTest Class Doc Comment
 *
 * @category    Class
 * @description ProductEnum
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ProductEnum
 */
class ProductEnumTest extends TestCase
{
    protected ProductEnum|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(ProductEnum::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ProductEnum::class));
        $this->assertInstanceOf(ProductEnum::class, $this->object);
    }
}
