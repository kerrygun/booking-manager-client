 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ReservationResponse
 */
class ReservationResponseTest extends TestCase
{
    protected ReservationResponse|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(ReservationResponse::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ReservationResponse::class));
        $this->assertInstanceOf(ReservationResponse::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyExpirationDate(): void
    {
        $this->markTestSkipped('Test for property expirationDate not implemented');
    }
    ...
    /**
     * Test attribute "baseFromId"
     *
     * @group unit
     * @small
     */
    public function testPropertyBaseFromId(): void
    {
        $this->markTestSkipped('Test for property baseFromId not implemented');
    }

    /**
     * Test attribute "baseToId"
     *
     * @group unit
     * @small
     */
    public function testPropertyBaseToId(): void
    {
        $this->markTestSkipped('Test for property baseToId not implemented');
    }
    ...
    {
        $this->markTestSkipped('Test for property clientName not implemented');
    }
}
