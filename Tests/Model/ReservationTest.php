 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Reservation
 */
class ReservationTest extends TestCase
{
    protected Reservation|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Reservation::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Reservation::class));
        $this->assertInstanceOf(Reservation::class, $this->object);
    }
    ...
    /**
     * Test attribute "cliendId"
     *
     * @group unit
     * @small
     */
    public function testPropertyCliendId(): void
    {
        $this->markTestSkipped('Test for property cliendId not implemented');
    }
