...
/**
 * SailingAreaTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\SailingArea
 */
class SailingAreaTest extends TestCase
{
    protected SailingArea|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(SailingArea::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(SailingArea::class));
        $this->assertInstanceOf(SailingArea::class, $this->object);
    }
