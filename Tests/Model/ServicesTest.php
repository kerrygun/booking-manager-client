 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Services
 */
class ServicesTest extends TestCase
{
    protected Services|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Services::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Services::class));
        $this->assertInstanceOf(Services::class, $this->object);
    }
