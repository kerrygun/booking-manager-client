...
/**
 * ShipyardTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\Shipyard
 */
class ShipyardTest extends TestCase
{
    protected Shipyard|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(Shipyard::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(Shipyard::class));
        $this->assertInstanceOf(Shipyard::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyShortName(): void
    {
        $this->markTestSkipped('Test for property shortName not implemented');
    }
}
