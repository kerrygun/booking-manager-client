...
/**
 * ShortAvailabilityTest Class Doc Comment
 *
 * @category    Class
 * @description ShortAvailability
 * @package     OpenAPI\Server\Tests\Model
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\ShortAvailability
 */
class ShortAvailabilityTest extends TestCase
{
    protected ShortAvailability|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(ShortAvailability::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(ShortAvailability::class));
        $this->assertInstanceOf(ShortAvailability::class, $this->object);
    }
     ...
     * @small
     */
    public function testPropertyBs(): void
    {
        $this->markTestSkipped('Test for property bs not implemented');
    }
}
