...
/**
 * WorldRegionTest Class Doc Comment
 *
 * @category    Class
 ...
 * @author      openapi-generator contributors
 * @link        https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \OpenAPI\Server\Model\WorldRegion
 */
class WorldRegionTest extends TestCase
{
    protected WorldRegion|MockObject $object;
    ...
    {
         $this->object = $this->getMockBuilder(WorldRegion::class)->getMockForAbstractClass();
    }
    ...
    {
        $this->assertTrue(class_exists(WorldRegion::class));
        $this->assertInstanceOf(WorldRegion::class, $this->object);
    }
